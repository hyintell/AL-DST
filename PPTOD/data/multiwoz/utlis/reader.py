...
class MultiWozReader(_ReaderBase):
    ...
    def _load_data(self, save_temp=False):
        ...
        for fn, dial in self.data.items():
            ...
            # CHANGE: remove 'police' and 'hospital' domain
            goal_domains = dial['goal'].keys()
            if 'police' in goal_domains or 'hospital' in goal_domains:
#                 print('=> skip police or hospital domain')
                continue
