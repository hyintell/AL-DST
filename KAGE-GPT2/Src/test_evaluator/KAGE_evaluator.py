...
class KAGEEvaluator(BaseEvaluator):
    def __init__(self, config, data_loader):
        ...
        if config.random_seed:
            ...
            print("SEED is set to:", config.random_seed)

#         # Set seed
#         if config.test.seed:
#             set_seed(config.test.seed)
#             print("SEED is set to:", config.test.seed)

        # Load tokenizer from training
        ############### Modify load tokenizer from training
...
#         tokenizer_path = os.path.join(self.config.saved_model_path, 'tokenizer')
        ...
        print('Test samples ', len(self.test_data_loader))
...
#             self.sagemaker_load_checkpoint_model(load_model_path=self.config.test.load_model_path)
#         else:
...
#                                        load_model_path=self.config.test.load_model_path)
        ...
        print("finished initialization...starting evaluation.")
