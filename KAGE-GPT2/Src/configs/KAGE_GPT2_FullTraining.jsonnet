// multiwoz 2.0
/*
local train_data_path = "../input/data/training/MultiWOZ/dst/train_v2.0.json";
local validation_data_path = "../input/data/training/MultiWOZ/dst/dev_v2.0.json";
local test_data_path = "../input/data/training/MultiWOZ/dst/test_v2.0.json";
...
local ontology_path = "../input/data/training/MultiWOZ/dst/ontology_v2.0.json";
*/

// multiwoz 2.1

local train_data_path = "../input/data/training/MultiWOZ/dst/train_v2.1.json";
local validation_data_path = "../input/data/training/MultiWOZ/dst/dev_v2.1.json";
local test_data_path = "../input/data/training/MultiWOZ/dst/test_v2.1.json";
local elmo_embedding_path = "../Materials/DSTQA/data/elmo_embeddings/all/";
local dummy_train_data_path = "../Materials/DSTQA/data/dummy/train.json";
local dummy_validation_data_path = "../Materials/DSTQA/data/dummy/dev.json";
local dummy_elmo_embedding_path = "../Materials/DSTQA/data/elmo_embeddings/dummy/";
local domain_slot_list_path = "../Materials/DSTQA/ontology/domain_slot_list_nosp.txt";
local preprocessed_data_path = "../Data/preprocessed_2.1_GPT2/";
local ontology_path = "../input/data/training/MultiWOZ/dst/ontology_v2.1.json";


local base_model = "gpt2";
local train_batch_size = 1;
local train_select_dialogue_batch_size = 24;
local train_select_turn_batch_size = 1;
local valid_batch_size = 2;
local valid_gen_batch_size = 16;
local test_batch_size = 16;
local save_interval = 5000;
local train_epochs = 1;
local lr = 6.25e-5;
local graph_lr = 8e-5;
...
local warmup_steps = 0;
{
  ...
  "train": {
    ...
    "train_select_dialogue_batch_size":train_select_dialogue_batch_size,
    "train_select_turn_batch_size": train_select_turn_batch_size,
